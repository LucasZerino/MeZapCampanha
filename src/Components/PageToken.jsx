    ...
    return (
        <div className="page-body-wrapper sidebar-icon">
                ...
                <div className="main-navbar">
                  ...
                  <div id="mainnav">           
                    <ul className="nav-menu custom-scrollbar">
                      ...
                      <li className="dropdown">
                      <a 
                        className={this.state.tab === "Token" ? "nav-link menu-title active" : "nav-link menu-title"} 
                        onClick={() => this.setState({tab: "Token"})} href='#'>
                            <i><DeviceHubIcon/></i>
                            <span>Token</span>
                        </a>
                      </li>
            ...
            <div className='seletor'>
                ...
                <div
                style={{display: this.state.tab === 'Token' ? "block" : "none"}}
                >
                    <TokenPage/>
                </div>
            </div>
